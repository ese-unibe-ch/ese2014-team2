    ...
    <div id="myCarousel" class="carousel slide">  
      <div class="carousel-inner">
        <div class="item active">
          ...
          <img src="img/slider_bg.gif" alt="Slide1">
          <div class="container">
            <div class="carousel-caption">
              <h2><span>Flattie v1.0</span></h2>
              <p class="caption"><span>Placing and Searching for ads and flats has never been that easy!</span></p>
              <p><a class="btn btn-primary" href="ads">Search <i class="fa fa-angle-double-right"></i></a>
            </p></div>
          </div>
        </div>
        <div class="item">
          <img src="img/slider_bg2.gif" alt="Slide2">
          <div class="container">
            <div class="carousel-caption">
              <h2><span>Flattie v1.0</span></h2>
              <p class="caption"><span>Test it yourself. Now!</span></p>
              <p><a class="btn btn-primary" href="#">Read More <i class="fa fa-angle-double-right"></i></a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img src="img/slider_bg3.gif" alt="Slide3">
          <div class="container">
            <div class="carousel-caption">
              <h2><span>Flattie v1.0</span></h2>
              <p class="caption"><span>Gigantic header of doom!</span></p>
              <p><a class="btn btn-primary" href="#">Read More <i class="fa fa-angle-double-right"></i></a></p>
            </div>
          </div>
        </div>
