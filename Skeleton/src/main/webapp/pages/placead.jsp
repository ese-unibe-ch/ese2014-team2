...
<div class="main">
	...
	<form:form method="post" modelAttribute="newAdForm" action="enlistad"
		...
		<fieldset>
			...
			<tr>
				<th><label for="image2">Image (in JPEG format only):</label></th>
				<td><input name="image2" type="file" />
			</tr>
			<tr>
				<th><label for="image3">Image (in JPEG format only):</label></th>
				<td><input name="image3" type="file" />
			</tr>
			<tr>
				<th><label for="image4">Image (in JPEG format only):</label></th>
				<td><input name="image4" type="file" />
			</tr>
