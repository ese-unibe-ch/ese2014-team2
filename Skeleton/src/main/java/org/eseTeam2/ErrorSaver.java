...
/**
 * 
 * This class stores the error messages catched into text files on the
 * server.For later debugging.
 * 
 * @author Ice
 *
 */
public class ErrorSaver {
	...
	try {
	    ...
	    // creates a new file and looksif afile with that name already
	    // exists.if it does then it adds a int number to the filename
	    // and checks again.
