...
public class MessageController {
    ...
    /**
     * this mapping method triggers when a user clicks on send message to ad
     * owner button in adProfile.jsp Redirects to the senderMessage.jsp page and
     * displays various information about the Message, like sender, receiver,
    ...
    /**
     * this mapping method is used to send a message to an user from an ad
     * appointment.
     * 
     * @param messageId
     * @param principal
    ...
    /**
     * this mapping method is used to show the details of a message. It
     * redirects to the "showMsg.jsp" page. Triggered when user clicks on a
     * message (inbox.jsp) It inserts the sender, the recipient, and the message
     * into the jsp, ans offers the user a way to answer the message
     * 
     * 
     * @param messageId
     *            Id of the message where the details should be shown for.
     * @param principal
     * @return
     */
    ...
    /**
     * this mapping method is triggered from all the message sending forms.
     * Takes in a message Form and converts it to a message object, stores it
     * into the database, and updates all corresponding Entities.
     * 
     * @param messageForm
     * @param principal
     * @return
    ...
    /**
     * This mapping method is used to create the users inbox.jsp page. It is
     * triggered by a click on inbox on the index.jsp page (logged in user) It
     * reads out all the users sent/received/notifications/appointment
     * invitations from the database and ads them to the model
     * 
     * @param principal
     * @return
     */
    @RequestMapping(value = "/myinbox", method = RequestMethod.GET)
    public ModelAndView inbox(HttpServletRequest request, Principal principal,
	    @ModelAttribute("infoMessage") String message, @ModelAttribute("tabToShow") String tabToShow) {
	...
	// the following 2 for loops check if the user deleted the message
	// locally, and only display if he didnt delete them yet. (Message stays
	// in db till both users deleted it)
    ...
    /**
     * this mapping method is a helper method which is triggered when a sent
     * message is deleted. it sets the SenderDeleted flag in the message object
     * to true.
     * 
     * @param principal
     * @param messageId
	...
	if (messageService.findBySenderAndId(currentUser, messageId) != null) {
	    ...
	    redirectAttributes
		    .addFlashAttribute("infoMessage", "Du versuchst die Nachricht eines anderen zu löschen!!");
	    return "redirect:/forbidden";
	}
    }

    /**
     * this mapping method is a helper method which is triggered when a received
     * message is deleted. it sets the RecipientDeleted flag in the message
     * object to true.
     * 
     * @param principal
     * @param messageId
    ...
    /**
     * This mapping method deletes a notification message from the database
     * completely.
     * 
     * @param principal
     * @param messageId
    ...
    public String deleteNotification(Principal principal,@RequestParam(value = "messageId", required = true) Long messageId, RedirectAttributes redirectAttributes) {
    ...
    /**
     * This mapping method deletes a invitation message from the database
     * completely.
     * 
     * @param principal
     * @param messageId
    ...
    public String deleteInvitation(Principal principal, @RequestParam(value = "messageId", required = true) Long messageId, RedirectAttributes redirectAttributes) {
